...
local options = {
    autoindent = true,
    autochdir = true,                           -- change pwd to a dir of currently opened file
    backup = false,                             -- creates a backup file
    -- undodir = os.getenv(HOME) .. /.vim/undodir,  -- undodir & undofile let you undo forever
    -- undofile = true,
    -- clipboard = "unnamedplus",               -- allows neovim to access the system clipboard doesnt really work that well
